...
btns_frame.pack()
#first row
clear = Button(btns_frame, text ="Clear" , fg = "black", width = 32, height = 3, bd = 0, cursor = "hand2", command= lambda:
...
multiply = Button(btns_frame, text= "*" ,fg = "black", width = 10, height = 3, bg = "#eee" ,cursor= "hand2" , command= lambda:
...
five = Button(btns_frame, text= "6", fg = "black", width = 10, height = 3, bd= 0, bg ="#fff" , cursor = "hand2" , command = lambda:
...
three = Button(btns_frame ,text = "3", fg = "black" , width = 10, height =3, bd = 0 ,bg ="#fff" , cursor = "hand2", command = lambda:
...
point = Button(btns_frame, text = ".", fg = "black", width = 21, height = 3, bd = 0, bg = "#eee", cursor = "hand2", command = lambda:
btn_click(".")).grid(row = 4, column = 1, columnspan = 2, padx = 1, pady = 1)
