...
window = Tk()
window.geometry("312x485") # size of the window width:- 500, height:- 375
...
e = Button(btns_frame, text = "e", fg = "black", width = 10, height = 3, bd = 0, bg = "#eee", cursor="hand2", 
                    command = lambda: btn_click("2.71")).grid(row = 4, column = 0, padx = 1, pady = 1)
# sixth row
brckt_open = Button(btns_frame, text = "(", fg = "black", width = 10, height = 3, bd = 0, bg = "#eee", cursor="hand2", 
                    command = lambda: btn_click("(")).grid(row = 5, column = 0, padx = 1, pady = 1)
brckt_close = Button(btns_frame, text = ")", fg = "black", width = 10, height = 3, bd = 0, bg = "#eee", cursor="hand2", 
                    command = lambda: btn_click(")")).grid(row = 5, column = 1, padx = 1, pady = 1)
perc = Button(btns_frame, text = "%", fg = "black", width = 10, height = 3, bd = 0, bg = "#eee", cursor="hand2", 
                    command = lambda: btn_click("/100")).grid(row = 5, column = 2, padx = 1, pady = 1)
pie = Button(btns_frame, text = "pi", fg = "black", width = 10, height = 3, bd = 0, bg = "#eee", cursor="hand2", 
                    command = lambda: btn_click("3.14")).grid(row = 5, column = 3, padx = 1, pady = 1)
# seventh row
sine = Button(btns_frame, text = "sin", fg = "black", width = 10, height = 3, bd = 0, bg = "#eee", cursor="hand2", 
                    command = lambda: btn_click("sin(")).grid(row = 6, column = 0, padx = 1, pady = 1)
cosine = Button(btns_frame, text = "cos", fg = "black", width = 10, height = 3, bd = 0, bg = "#eee", cursor="hand2", 
                    command = lambda: btn_click("cos(")).grid(row = 6, column = 1, padx = 1, pady = 1)
tangent = Button(btns_frame, text = "tan", fg = "black", width = 10, height = 3, bd = 0, bg = "#eee", cursor="hand2", 
                    command = lambda: btn_click("tan(")).grid(row = 6, column = 2, padx = 1, pady = 1)
modes = Button(btns_frame, text = "MODE", fg = "black", width = 10, height = 3, bd = 0, bg = "#eee", cursor="hand2", 
                    command = lambda: btn_click(" ")).grid(row = 6, column = 3, padx = 1, pady = 1)
# eighth row
ln = Button(btns_frame, text = "log", fg = "black", width = 10, height = 3, bd = 0, bg = "#eee", cursor="hand2", 
                    command = lambda: btn_click("log(")).grid(row = 7, column = 0, padx = 1, pady = 1)
sr = Button(btns_frame, text = "SQRT", fg = "black", width = 10, height = 3, bd = 0, bg = "#eee", cursor="hand2", 
                    command = lambda: btn_click("sqrt(")).grid(row = 7, column = 1, padx = 1, pady = 1)
power = Button(btns_frame, text = "power", fg = "black", width = 10, height = 3, bd = 0, bg = "#eee", cursor="hand2", 
                    command = lambda: btn_click("**")).grid(row = 7, column = 2, padx = 1, pady = 1)
shift = Button(btns_frame, text = "SHIFT", fg = "black", width = 10, height = 3, bd = 0, bg = "#eee", cursor="hand2", 
                    command = lambda: btn_click(" ")).grid(row = 7, column = 3, padx = 1, pady = 1)
window.mainloop()
